...
/**
 * OA统一审批服务Feign客户端。
 * <p>CRM业务单据（销售订单）通过此客户端向OA提交审批申请，
 * 审批完成后OA通过回调URL通知CRM更新业务状态，实现审批闭环。</p>
 */
@FeignClient(name = "oa-service", path = "/api/v1/oa/unified-approval", contextId = "crmOaApprovalClient")
