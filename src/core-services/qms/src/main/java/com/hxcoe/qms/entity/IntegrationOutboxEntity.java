...
@Data
@Entity
@Table(name = "qms_integration_outbox",
        uniqueConstraints = {
                @UniqueConstraint(name = "uk_qms_outbox_event_ref", columnNames = {"event_type", "ref_no"}),
                @UniqueConstraint(name = "uk_qms_outbox_event_id", columnNames = {"event_id"})
        })
