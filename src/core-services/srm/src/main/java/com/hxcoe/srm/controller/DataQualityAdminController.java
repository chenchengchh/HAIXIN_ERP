...
@RestController
@RequestMapping("/api/v1/srm/admin/data-quality")
public class DataQualityAdminController {
    ...
    public Result<Map<String, Object>> refresh() {
        return Result.success("刷新成功", srmDataQualityService.refresh());
    }
    ...
    public Result<PageResult<Map<String, Object>>> tasks(
        ...
        return Result.success("查询成功", srmDataQualityService.listTasks(page, size, status));
    }
    ...
    public Result<Boolean> resolve(@PathVariable Long id, @RequestBody Map<String, Object> body) {
        ...
        boolean ok = srmDataQualityService.resolveTask(id, resolution, status);
    ...
    public Result<List<Map<String, Object>>> metrics(
        ...
        return Result.success("查询成功", srmDataQualityService.listMetrics(date));
    }

    @GetMapping("/health")
    public Result<Map<String, Object>> health() {
        Map<String, Object> m = new HashMap<>();
        m.put("openTaskCount", srmDataQualityService.listTasks(1, 1, "OPEN").getTotal());
        return Result.success("OK", m);
    }
}
