...
/**
 * OA统一审批服务Feign客户端。
 * <p>ERP各业务单据（凭证/生产订单/供应链单据）通过此客户端向OA提交审批申请，
 * 审批完成后OA通过回调URL通知ERP更新业务状态，实现审批闭环。</p>
 */
@FeignClient(name = "oa-service", path = "/api/v1/oa/unified-approval", contextId = "erpOaApprovalClient")
