...
public class ErpPoFactRedisStreamJob {
    ...
    public void poll() {
        ...
        String stream = integrationTransportProperties.getRedis().getStreamErpPoFacts();
        String group = integrationTransportProperties.getRedis().getGroupErpPoFacts();
        String consumer = integrationTransportProperties.getRedis().getConsumerErpPoFacts();
        ...
        try {
            ...
            log.warn("ERP Redis Stream 读取失败 stream={} error={} nextRetryInMs={}", stream, ex.getMessage(), delayMs);
            return;
        }
        ...
        for (MapRecord<String, Object, Object> r : records) {
            try {
                ...
                log.warn("ERP Redis Stream 消费失败 stream={} recordId={} error={}", stream, r.getId(), ex.getMessage());
            }
        }
    }
