...
@RestController
@RequestMapping("/api/v1/hr/admin/data-quality")
public class DataQualityAdminController {
    ...
    public Result<Map<String, Object>> refresh() {
        return Result.success("刷新成功", hrDataQualityService.refresh());
    }
    ...
    public Result<PageResult<Map<String, Object>>> tasks(
        ...
        return Result.success("查询成功", hrDataQualityService.listTasks(page, size, status));
    }
    ...
    public Result<Boolean> resolve(@PathVariable Long id, @RequestBody Map<String, Object> body) {
        ...
        boolean ok = hrDataQualityService.resolveTask(id, resolution, status);
    ...
    public Result<List<Map<String, Object>>> metrics(
        ...
        return Result.success("查询成功", hrDataQualityService.listMetrics(date));
    }
}
