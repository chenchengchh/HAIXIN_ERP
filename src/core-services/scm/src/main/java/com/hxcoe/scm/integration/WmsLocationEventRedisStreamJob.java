...
public class WmsLocationEventRedisStreamJob {
    ...
    public void poll() {
        ...
        String stream = integrationTransportProperties.getRedis().getStreamWmsLocationEvents();
        String group = integrationTransportProperties.getRedis().getGroupWmsLocationEvents();
        String consumer = integrationTransportProperties.getRedis().getConsumerWmsLocationEvents();
        ...
        for (MapRecord<String, Object, Object> r : records) {
            try {
                ...
                LocationEventRequest req = objectMapper.readValue(body, LocationEventRequest.class);
