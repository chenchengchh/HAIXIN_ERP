...
@RestController
@RequestMapping("/api/v1/eam/admin/data-quality")
public class DataQualityAdminController {
    ...
    public Result<Map<String, Object>> refresh() {
        return Result.success("刷新成功", eamDataQualityService.refresh());
    }
    ...
    public Result<PageResult<Map<String, Object>>> tasks(
        ...
        return Result.success("查询成功", eamDataQualityService.listTasks(page, size, status));
    }
    ...
    public Result<Boolean> resolve(@PathVariable Long id, @RequestBody Map<String, Object> body) {
        ...
        boolean ok = eamDataQualityService.resolveTask(id, resolution, status);
    ...
    public Result<List<Map<String, Object>>> metrics(
        ...
        return Result.success("查询成功", eamDataQualityService.listMetrics(date));
    }
}
