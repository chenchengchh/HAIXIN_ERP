 ...
 * 反序列化采用容错模式：同时兼容"yyyy-MM-dd HH:mm:ss"（内部服务格式）
 * 与ISO格式"yyyy-MM-dd'T'HH:mm:ss"（跨模块调用方格式），避免跨模块Feign调用400。
 */
@Configuration
    ...
    static class LenientLocalDateTimeDeserializer extends JsonDeserializer<LocalDateTime> {
        ...
        public LocalDateTime deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            try {
                ...
                // 回退ISO格式：兼容 2026-08-01T12:00:00、2026-08-02T00:11:09.009Z（前端Date序列化格式）
