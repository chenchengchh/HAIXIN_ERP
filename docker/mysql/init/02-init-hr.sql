...
DELIMITER //
DROP PROCEDURE IF EXISTS seed_hr//
CREATE PROCEDURE seed_hr()
BEGIN
  IF EXISTS (
    SELECT 1
...
-- 清空现有数据
DELETE FROM hr_attendance_exception;
DELETE FROM hr_leave_request;
DELETE FROM hr_interview;
DELETE FROM hr_resume;
DELETE FROM hr_recruitment_demand;
DELETE FROM hr_resignation_request;
DELETE FROM hr_salary_adjustment;
DELETE FROM hr_transfer_record;
DELETE FROM hr_performance_appraisal;
DELETE FROM hr_performance_objective;
DELETE FROM hr_attendance_record;
DELETE FROM hr_payroll_record;
